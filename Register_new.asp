...
<head>
  ...
  <!-- Basic Page Needs
  =========================
  <title>Register - Evolve Foundation</title>
========================= -->
  <meta charset="utf-8">
...
<script>
	function SaveData(){               
				...
				var vfile = $("#file").val();		
				var vtxtCompanyProfile = $("#txtCompanyProfile").val();
				var vpatentsissues = $("#patentsissues").val();
				var vyearfounded = $("#yearfounded").val();
				var vnumberofemployees = $("#numberofemployees").val();
				var v2021revenue = $("#2021revenue").val();
				var v2022revenue = $("#2022revenue").val();
				var v2023revenue = $("#2023revenue").val();
				var vMajor_Milestones_Achieved = $("#Major_Milestones_Achieved").val();
				var vunrestrictedlink = $("#unrestrictedlink").val();
  ...
  <div class="w-100 mt-3">
      ...
      <div class="row mx-2">
		...
		<!---div class=" col-12 ml-4  pl-1 pb-2 d-flex align-items-center  justify-content-start mb-3">
					 ...
					 <div class="w-100 mb-3 mx-2 collapse show" id="collapseExample2" style="">
					 <form method="post" action="upload_Image_Initiativ.asp"  ENCTYPE="multipart/form-data" id="myform" class="w-100">

              <div class="row position-relative d-flex align-items-center mb-5"> 
										 ...
										 '' RESPONSE.WRITE session("imgPath")
										   '' Dim objFso  
											Set objFso= CreateObject("Scripting.FileSystemObject")                                                 
											  If objFso.FileExists(session("UPath")&"\"&Trim(session("intiativeimgPath"))) then%>
													<img src="/EvolvImages/<%=Trim(session("intiativeimgPath"))%>" class="img-fluid mx-auto " title="profile_img" title="profile_img" />
											<%Else%>
...
<div class="d-flex justify-content-center align-items-center">
						...
						<input type="file" id="file"  name="file" value="/EvolvImages/<%=Trim(session("intiativeimgPath"))%>" class=" button form-control-file btn btn-sm" style="font-size: 12px;color:#fff;background: #fff;display: block;width:81px;overflow: hidden;padding: 0px;" tabindex="9" onchange="return fileValidation()">
        ...
        <div class="col-sm-12 mb-3 px-1">
          <div class="set-form d-flex">
            <table id="myTable" class="w-100">
			  ...
			  <td class="col-sm-2 col-4  px-1"> <div class="d-flex justify-content-start align-items-center">
			  
			  
			  
			  <!--input  type="button" title="Save"  onclick="addCompanyFields()" class="btn btn-sm btn-primary mx-1 form-savebutton" style=" border-radius: 5px; background: green;"/-->    
			  <div class="set-form">
			
			 
			  
			  <input title="Save" id="more_fields" onclick="add_fields();" value="+ " class="btn btn-sm btn-primary mx-1" style="border-radius: 5px;font-weight: bold;font-size: 25px !important;padding: 0 13px; width: 40px !important;"/> 
        ...
        <div class="col-sm-12 mb-3 px-1">
          <textarea rows="4" cols="50" id="txtCompanyProfile" name="txtCompanyProfile" class="w-100" form="usrform" placeholder=" 1500 characters Limit"></textarea>
        </div>
...
<!--input  type="button" title="Save" onclick="addCompanyInvestorDetails()" class="btn btn-sm btn-primary mx-1 form-savebutton " style=" border-radius: 5px; background: green;"/-->  
 <div class="set-form">
			
			 
			  
			  
			    <input title="add" id="more_fields" onclick="add_fields2();" value="+ " class="btn btn-sm btn-primary mx-1" style="border-radius: 5px;font-weight: bold;font-size: 25px !important;padding: 0 13px; width:40px !important;"/> 
		...
		<div class="mt-2 row mx-0 w-100">
          <div class="col-sm-4 mb-3 px-1">
            <input class="form-control w-100 border-radius-0 " id="2021revenue" name="2021revenue" type="text" />
            <span class="floating-label"> 2021 Revenues (In USD)</span>
          </div>
          <div class="col-sm-4 mb-3 px-1">
            <input class="form-control w-100 border-radius-0 "  id="2022revenue" name="2022revenue" type="text" required="" />
            <span class="floating-label"> 2022 Revenues (In USD)</span>
          </div>
          <div class="col-sm-4 mb-3 px-1">
            <input class="form-control w-100 border-radius-0 " id="2023revenue" name="2023revenue" type="text" required="" />
            <span class="floating-label"> 2023 Revenues (In USD)</span>
          </div>
        </div>
        <div class="col-12 mb-1">
        ...
        <div class="col-sm-12 mb-3 px-1">
          <textarea rows="4" cols="50" id="Major_Milestones_Achieved" name="Major_Milestones_Achieved" class="w-100" form="usrform" placeholder=" 1500 characters Limit"></textarea>
        </div>
        <!---DOMAIN EXPERTS -->
        ...
        <div class="col-sm-12 mb-3 px-1 d-flex align-items-center ">
            ...
            <input class="form-control border-radius-0 " type="text" id="unrestrictedlink" name="unrestrictedlink" required="">
          </div>
		...
		<div class="d-flex align-items-start mt-2 ml-2 pl-1">
						 <input type="checkbox" id="acceptprivacy" name="acceptprivacy" class="mr-2 mt-2">
 ...
 <script type="text/javascript">
  ...
  function add_fields() {
    ...
    if (lastRowIndex < 10) {
      ...
      row.innerHTML = '<tr class="mt-2"><td class="col-sm-5 col-12 px-1"><input class="form-control w-100 border-radius-0" placeholder="Name ' + lastRowIndex + '" id="company_board_person_name' + lastRowIndex + '" name="company_board_person_name' + lastRowIndex + '" type="text" required=""></td><td class="col-sm-5 col-8 px-1"><input placeholder="Company ' + lastRowIndex + '" class="form-control w-100 border-radius-0" id="company_board_company_name' + lastRowIndex + '" name="company_board_company_name' + lastRowIndex + '" type="text" required=""></td><td class="col-sm-2 col-4 px-1"><div class="d-flex justify-content-start align-items-center"><!--input type="button" title="Save" class="btn btn-sm btn-primary mx-1 form-savebutton" style="border-radius: 5px; background: green;" id="save"/--><button title="Remove" class="btn btn-sm btn-primary mx-1 border-0 remove-button" style="border-radius: 5px; background: red;" id="remove"><i class="fa fa-times" aria-hidden="true"></i></button></td></tr>';
    }
  }
    ...
    for (var i = 0; i < lastRowIndex; i++) {
      ...
      if (vcompany_board_person_name !== null && vcompany_board_person_name !== '' && vcompany_board_company_name !== null && vcompany_board_company_name !== '') {
        $.ajax({
          ...
          type: "POST",
          data: 'vSno=' + encodeURIComponent(i) + '&vcompany_board_person_name=' + encodeURIComponent(vcompany_board_person_name) + '&vcompany_board_company_name=' + encodeURIComponent(vcompany_board_company_name) + '&vCompany=' + encodeURIComponent(vCompany) + '&vEmail=' + encodeURIComponent(vEmail) + '',
          success: function(data) {
		 // alert(data);
		  },
          error: function(xhr, ajaxOptions, thrownError) {
...
<script type="text/javascript">
  ...
  function add_fields2() {
    ...
    if (lastRowIndex1 < 10) {
      ...
      var row = table.insertRow(-1);
      row.innerHTML = '<tr class="mt-2"><td class="col-sm-7 col-12 px-1"><input class="form-control w-100 border-radius-0" placeholder="Firm ' + lastRowIndex1 + '" id="investor_firm_name' + lastRowIndex1 + '" name="investor_firm_name' + lastRowIndex1 + '" type="text" required=""></td><td class="col-sm-3 col-8  px-1"><input placeholder="Amount ' + lastRowIndex1 + '" class="form-control w-100 border-radius-0" id="Investor_amount' + lastRowIndex1 + '" name="Investor_amount' + lastRowIndex1 + '" type="text" required=""></td><td class="col-sm-2 col-4  px-1"><div class="d-flex justify-content-start align-items-center"><!--input type="button" title="Save" class="btn btn-sm btn-primary mx-1 form-savebutton" style="border-radius: 5px; background: green;"/></button--><button title="Remove" class="btn btn-sm btn-primary mx-1 border-0 remove-button" style="border-radius: 5px; background: red;"><i class="fa fa-times" aria-hidden="true"></i></button></td></tr>';
    }
  }
