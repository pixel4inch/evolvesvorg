          ...
          <div id="domainlist" class="domainlist d-flex flex-wrap justify-content-cener align-items-center p-2">
				...
				<%If trim(Start1)>=101 Then%>
					...
					DOMAIN EXPERTS COUNT# 443756
						...
						<div class="w-100   mb-1" style="display: flex;justify-content: center;gap:25px;align-items-center width: 100%;padding: 10px;z-index:999;/* height:30px; */">
						<a class="a_back  a_nav <%=SelectedActive(request("Cp"),GTnum) %>" href="View_Industry_Speakers.asp?industry=<%=trim(request("industry"))%>&sno=<%=trim(request("sno"))%>&Start=<%=server.urlencode(EnDeCrypt(trim(StartBack),CHkGiaPSWD))%>&amp;E=<%=E1%>&amp;SrcType=<%=Trim(RESrcTypeSTR)%>&amp;SRCWord=<%=Trim(RESRCWordSTR)%>&amp;EncryptSTR=<%=Trim(request("EncryptSTR"))%>&ShowType=<%=trim(REShowTypeSTR)%>&EID=<%=trim(REEIDSTR)%>&cnt=<%=trim(REcntSTR)%>#section-top"  style=" margin: 10px 10px 10px 35px; align-items: center; display:flex ;  font-weight: bold;   font-size: 17px;"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a>
								
								<h1 class="font-display2 text-center main-font-color mb-0" style="line-height: normal !important;"><%'=request("ititle")%> GLOBAL DOMAIN EXPERT NETWORK POOL</h1>
								<a class="a_next a_nav <%=SelectedActive(request("Cp"),GTnum) %>" href="View_Industry_Speakers.asp?industry=<%=trim(request("industry"))%>&sno=<%=trim(request("sno"))%>&Start=<%=server.urlencode(EnDeCrypt(trim(Start1),CHkGiaPSWD))%>&amp;E=<%=E1%>&amp;SrcType=<%=Trim(RESrcTypeSTR)%>&amp;SRCWord=<%=Trim(RESRCWordSTR)%>&amp;EncryptSTR=<%=Trim(request("EncryptSTR"))%>&ShowType=<%=trim(REShowTypeSTR)%>&EID=<%=trim(REEIDSTR)%>&cnt=<%=trim(REcntSTR)%>#section-top"  style=" margin: 10px 35px 10px 10px;   align-items: center; display:flex ;font-weight: bold;   font-size: 17px;"><i class="fa fa-angle-double-right" aria-hidden="true"></i> </a>
					</div>
			...
			<!---
			<a target="_new1" href="https://www.evolv.cc/show_innovator_synergies.asp?GetTypePage=SYNNOVATE100" class="mx-2 text-white program-buttons speaker_button">SPEAKERS INVITE POOL</a>
			<a target="_new1" href="https://www.evolv.cc/show_innovator_synergies.asp?GetTypePage=SYNNOVATE100" class=" mx-2  text-white program-buttons speaker_button">INFLUENCERS</a>
			
			--->
			<!--
			https://evolvesv.org/View_Industry_Speakers.asp?industry=ai&sno=222&Start=%9Ea&E=&SrcType=&SRCWord=&EncryptSTR=&ShowType=&EID=&cnt=
			-->
			<div class="row">
			
							<p class="Alp_Display w-100 my-1 text-center"> 
							  <a class="<%=SelectedActive(SRCWordSTR,"[A]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[A]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&srctype=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">A</a> 
							  <a class="<%=SelectedActive(SRCWordSTR,"[B]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[B]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">B</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[C]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[C]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">C</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[D]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[D]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">D</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[E]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[E]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">E</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[F]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[F]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">F</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[G]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[G]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">G</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[H]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[H]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">H</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[I]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[I]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">I</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[J]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[J]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">J</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[K]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[K]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">K</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[L]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[L]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">L</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[M]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[M]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">M</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[N]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[N]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">N</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[O]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[O]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">O</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[P]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[P]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">P</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Q]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Q]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Q</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[R]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[R]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">R</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[S]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[S]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">S</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[T]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[T]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">T</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[U]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[U]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">U</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[V]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[V]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">V</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[W]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[W]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">W</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[X]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[X]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">X</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Y]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Y]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Y</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Z]") %>" href="View_Industry_Speakers.asp?industry=<%=request("industry")%>&EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Z]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Z</a>
				  		   </p>
					 </div>
			</div>
				<div class="rounded  p-2 bg-white" >
					 ...
					 <!--div class="row">	
							...
							CountryQry="SELECT distinct first_name,last_name,headline,company_name,Image_url FROM [EvolveSV].[dbo].[Speakers_List_DO_Tool]  WHERE (headline like ('%CEO%') OR headline like ('%President%') OR headline like ('%Chief%') OR headline like ('%founder%')) and Image_url is not null and trim(Image_url)<>''"
