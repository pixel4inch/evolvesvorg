...
=============================-->
    ...
    <div id="writeup-title">
        <h2><%=ucase(request("EventId"))%> FOUNDERS</h2>
    </div>

    <section class="section py-3 d-none">
        <div class="container">
            <div class="row align-items-center m-0 ">
                <img src="./images/evolv/data/womenunicon.jpg" class="img-fluid" />
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div id="collapseblock" class="w-100">
                ...
                <div class="bg-light py-2">
                    <div class="container">
                        <div
                            class="d-none justify-content-center align-items-center flex-wrap flex-coloum flex-lg-row my-2 w-100  ">
                ...
                <div class=" w-100 mx-0 mt-3">
                    <div class="container">
                        ...
                        <!---PROGRAM DETAILS--->
                        <div class="collapse show   mt-0 border-top border-bottom " id="collapseExample3"
                            data-parent="#collapseblock">
                            ...
                            <div class="bg-light p-3">
                                <div class="row m-3 d-none">
                                    <div class="col-lg-1 col-md-2 col-2 d-none">
                                    <h5 class="font-weight-bold">Title:</h5>
                                </div>
                                <div class="col-lg-11 col-md-10 col-10 d-none">
                                    <h5>WOMAN UNICORN</h5>
                                   </div>
                                </div>
                            ...
                            <div class="px-4 d-none pb-2 bg-white rounded">
                                <!-- Bordered tabs-->
                                        ...
                                        <div class="row mx-0 ">
                                                ...
                                                <div class="w-100 border-top mt-3 pt-3">
                                                    <div class="light-bg py-2">
                                                       ...
                                                       <h4 class="font-display3 main-font-color mt-1">Exploring the What, Why & Who of WOMAN UNICORN in Enterprise </h4>
                                                       <p class="mt-2">WOMAN UNICORN is playing an ever important role in business. But how effectively are companies implementing this technology across both products and processes?</p>
   
                                                       <p class="mt-3">This session will help attendees </p>
                                                       <ul class="mx-0 mt-1 px-4 py-2">
                                                          <li>Hear about the role of enterprise WOMAN UNICORN </li>
                                                          <li>Why and how the technology can help </li>
                                                           <li>Identify barriers and challenges to adoption and implementation</li>
                                                               <li>Understand the most effective ways to leverage Enterprise WOMAN UNICORN </li>
                                        ...
                                        <div class="row mx-0 ">
                                            ...
                                            <div class="w-100 border-top mt-3 pt-3">
                                                <div class="light-bg py-2">
                                                   ...
                                                   <h4 class="font-display3 main-font-color mt-1">What’s Next for WOMAN UNICORN. Recent Advancements & Innovations  </h4>
                                                   <p class="mt-2">After decades of slow burn, WOMAN UNICORN is now a raging fire with developments taking place at a rapid pace. Innovation has been and continues to be the fuel for this fire. </p>
                                        ...
                                        <div class="row mx-0 ">
                                            ...
                                            <div class="w-100 border-top mt-3 pt-3">
                                                <div class="light-bg py-2">
                                                   ...
                                                   <h4 class="font-display3 main-font-color mt-1">Understanding & Building Ethics in WOMAN UNICORN   </h4>
                                                   <p class="mt-2">We are beginning to learn that WOMAN UNICORN scales not just solutions and capabilities but also risks. WOMAN UNICORN ethics is now a business necessity and is no longer just an academic curiosity. Ethical decisions are needed to guide research, development and use of AI. Researchers and companies alike need a clear plan to deal with ethical quandaries. </p>

                                                   <p class="mt-3">This session will help attendees   </p>
                                                   <ul class="mx-0 mt-1 px-4 py-2">
                                                      <li>Understand and create WOMAN UNICORN ethical risk framework tailored to specific industry and/or company needs.  </li>
                                                      <li>Learn about ethical issues that arise with WOMAN UNICORN systems </li>
                                                       <li>Develop well-crafted WOMAN UNICORN ethics statement.</li>
                                                           <li>Optimize guidance and tools for product managers, build organizational awareness and incentivize employees to play a role in identifying WOMAN UNICORN ethical issues. 
