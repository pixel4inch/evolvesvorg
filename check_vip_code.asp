                        ...
                        <div class="mt-4" id="collapseExample">
                            ...
                            <div class="w-100">
                                 ...
                                 <div class="row mx-0">
									...
									<label class="form-check-labe mb-0  ml-0 mt-2 " for="exampleCheck1"> Spouse Will Also Join</label>
									</div>
									...
									<div class="panel-collapse shadow-sm border mt-3 p-4 collapse   w-100" id="Spouseform" >
											...
											<div class="row mx-0 my-3">
												 ...
												 <div class="col-sm-6 mb-2 p-1">
                                         <span class="floating-label"> Spouse First Name <span class="text-danger">*</span> </span>
                                         <input class="form-control main mb-1 " type="text"  id="Sfirst_name" name="Sfirst_name" required="">
                                     </div>
                                    
                                     <div class="col-sm-6 mb-3 p-1">
                                        <span class="floating-label"> Spouse Last Name <span class="text-danger">*</span> </span>
                                         <input class="form-control main mb-1" type="text" id="Slast_name" name="Slast_name" required="">
                                     </div>
									 
								    <div class="col-sm-6 mb-3 p-1">
                                         <span class="floating-label"> Spouse Designation   </span>
                                         <input class="form-control main mb-1" type="text"  id="Sdesignation" name="Sdesignation" required="">
                                     </div>
									 
									   <div class="col-sm-6 mb-3 p-1">
                                         <span class="floating-label"> Spouse Organization   </span>
                                         <input class="form-control main mb-1" type="text"  id="SCompany" name="SCompany" required="">
                                     </div>
                                   
                                     <div class="col-sm-6 mb-3 p-1">
                                         <span class="floating-label"> Spouse Email   </span>
                                         <input class="form-control main mb-1" type="email"  id="Semail" name="Semail" required="">
                                     </div>
                                    
                                     <div class="col-sm-6 mb-3 p-1">
                                          <span class="floating-label"> Spouse Phone  </span>
                                         <input class="form-control main mb-1" type="number"  id="Sphone" name="Sphone" >
                                     </div>
									 
                                   
                                     <div class="col-sm-6 mb-3 p-1">
                                          <span class="floating-label"> Spouse LinkedIn </span>
                                         <input class="form-control main mb-1" type="text" id="SlinkedInLink" name="SlinkedInLink" >
                                     </div>
									 
									<div class="d-flex w-100 justify-content-start align-items-center flex-wrap"> 
									 <div class="d-flex align-items-start mt-0 ml-0 pl-1 mr-3 ">
										 <input type="checkbox" id="Sattendsessions" name="Sattendsessions" val="Y" class="mr-2 mt-2 ">
										 <p class="mt-1">Spouse Will Attend Sessions</p>					 
									 </div>
									 
									 <div class="d-flex align-items-start mt-1 ml-0 pl-1 ">
										 <input type="checkbox" id="Sattendbanquet" name="Sattendbanquet"  val="Y" class="mr-2 mt-2 ">
										 <p class="mt-1">Spouse Will Attend Banquet</p>					 
									 </div>
									 </div>
