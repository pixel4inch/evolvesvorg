						...
						<!------------------>
						 ...
						 <!-----section1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">DEEP-TECH</h3>
...
<a class="collapse_click collapsed" data-toggle="collapse" href="#INVESTORS_byperson" role="button" aria-expanded="false" aria-controls="collapseExample">	  
						...
						<div class="p-2 data-section">
						 ...
						 <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">VENTURE CAPITAL</h3>
											
											<a  href="Show_VentureCapital_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>66,943</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<a  href="Show_AngelGroups_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>5,094</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<a  href="Show_ACCELERATOR_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>6,099</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<a  href="Show_Incubator_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3,495</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">FAMILY OFFICES</h3>
											...
											<a  href="Show_Family_Investment_Office_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3,085</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">PRIVATE EQUITY</h3>
											
											<a  href="Show_PrivateEquity_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>26,475</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">CORPORATE VENTURE CAPITAL</h3>
											
											<a  href="Show_CorporateVentureCapital_Companies.asp?SRCWord=%F6%12%EA" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3,730</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
		...
		<div class="p-2 data-section">
							...
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class='  font-display3 counter' data-min='1' data-max='22069' data-delay='5' data-increment='20'>22,069</span>
							</h3>
								</a>
							</div>
		...
		<div class="p-2 data-section">
							...
							<a  href="Show_Academia_List.asp?SRCWord=%F6%12%EA"  >
							<h3 class="mt-2 text-capitalize  h2 ">
