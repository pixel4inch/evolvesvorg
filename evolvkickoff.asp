				...
				if (checkbox1_check == 1)
				{
					...
					$.ajax({
								...
								success: function(data){
									...
									if (data==1)
									{
										alert ("Your are confirmed. See you on 29th. Thank you");
      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-10 m-auto">
				<div class="border-bottom pb-3">
					  <h1 class="font-display1 text-center main-font-color mx-auto" style="margin-bottom:12px !important">EVOLV<sup style="font-size:12px; top:-10px">TM</sup> PROGRAM LAUNCH <br/> B20 INDIA ROADSHOW</h1>
				...
				<div class=" w-100   w-100 mt-3 bg-light shadow-sm border ">
					...
					<div class="d-flex flex-column flex-xl-row flex-lg-row  flex-md-row w-100 justify-content-lg-center  py-2 px-2 justify-content-start">							
							<div class=" d-flex flex-row align-itmes-center mr-3 my-2 ">
					...
					<div class="d-flex flex-column flex-xl-row flex-lg-row  flex-md-row w-100 justify-content-lg-center  py-2 px-2 justify-content-start">
									<FONR COLOR=RED>REGISTRATIONS ARE NOW CLOSED</FONT>
								</div>
				...
				If trim(request("txtInvite_code"))<>"" Then
							...
							IF not rsChkInvite.EOF Then
								If ucase(trim(rsChkInvite("Invite_Type")))="VIP" Then
									Invite_name="<b>GUEST OF " & ucase(rsChkInvite("Display_name")) & "</b><br/><font color='red'> VIP LUNCHEON IN CYPRUS ROOM @ 12:15PM </font>"
									''Invite_name = Invite_name & " "
								Else
									Invite_name="<b>GUEST OF " & ucase(rsChkInvite("Display_name")) & "</b>"
								End If
								...
								IF not RecChkRS.EOF Then
									Invite_name="<b>INVITATION FOR " & ucase(RecChkRS("first_name")) & " " & ucase(RecChkRS("last_name")) & "</b><br/><font color='red'> Note: Please update any outdated data and click on SUBMIT button. </font>"
							...
							If InviteType = 0 Then
								response.write "<font color=red>INVALID INVITATION CODE.</font>"
								response.write "<br/><br/> <button onclick='history.back()'>Go Back</button>"
								response.end
							End If
				End If			
 %>
					...
					<%If trim(session("InfCode"))<>"" Then%>
						<small> Fields marked with <span style="color:red">*</span> are mandatory. </small></p>
						 ...
						 <div class="d-flex  mt-2 ml-2">
										 <input type="checkbox" id="acceptprivacy" name="acceptprivacy" class="mr-1 mt-1"/>
										 <p class="text-left">I have read and agree to the Evolv Program  <a href="https://www.evolv.cc/privacy.html" style="color:blue"> Privacy Policy </a> and <a href="https://www.evolv.cc/serviceagreements.html" style="color:blue"> Service Agreement. </a> </p>
						 </div>
					...
					<%Else%>
						<small> Fields marked with <span style="color:red">*</span> are mandatory. To complete your request, you must be authenticated via Linkedin. </small></p>
						 ...
						 <div class="d-flex  mt-2 ml-1">
										 <input type="checkbox" id="acceptprivacy" name="acceptprivacy" class="mr-2 mt-1"/>
										 <p class="text-left">I have read and agree to the Evolv Program  <a href="https://www.evolv.cc/privacy.html" style="color:blue"> Privacy Policy </a> and <a href="https://www.evolv.cc/serviceagreements.html" style="color:blue"> Service Agreement. </a> </p>					 </div>
			...
			PROGRAM BLOCK END------->
				...
				<h3 class="font-display3 pt-4 main-font-color mb-3 text-center  pb-2">PROGRAM</h3>
				...
				<div class="d-flex flex-column flex-column mr-2 justify-content-start">
					<div class="d-block  col-12 pl-0 m-l-0 text-left mt-2 " >10:00 - 10:45 AM:</div>
						<div class="d-block   col-12 pl-0 ml-0 mt-2 text-left">
						<p class="d-block  " style="font-weight:600">EVOLV<sup style="font-size:9px; top:-4px">TM</sup> PROGRAM LAUNCH</p>
							...
							<div class="row mt-4 justify-content-center ">
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Rajan Navani" >Rajan Navani</h3>
												 <p class="text-center designation" title="Founder & CEO">Founder &amp; CEO</p>
												  <p class="text-center designation" title="JetSynthesys">JetSynthesys </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ram K Reddy">Ram K Reddy</h3>
												 <p class="text-center designation" title=" Founder &; CEO">Founder &amp; CEO</p>
												  <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->						
				...
				<div class="d-flex flex-column flex-column mr-2 justify-content-start">
					...
					<p class="d-block mt-1">Hosted by Consul General of India and the Director General of the Confederation of Indian Industry (CII) with guest invitee G20 Consuls. <a href="https://www.g20.org/en/" style="color:blue" target="_blank">www.g202023.in</a> As the official Secretariat of B20 2023, <a href="https://www.b20india2023.org/new-homepage" style="color:blue" target="_blank" >www.b20india2023.org</a> CII sets the agenda. The Director General will present details of how innovation ecosystems in G20 countries can get involved with multiple domain-focused programs.</p>
							...
							<div class="row mt-4 justify-content-center ">
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Dr. TV Nagendra Prasad">Dr. TV Nagendra Prasad</h3>
												 <p class="text-center designation" title="Consulate General of India">Consulate General of India</p>
												  <p class="text-center designation" title="San Francisco, CA">San Francisco, CA </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/chandrajitbanerjee/" target="_blank">
												<img class="w-100 shadow border img-fluid" src="./images/Speaker_Images/C_Banerjee.jpg" alt="member-image"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Chandrajit Banerjee">Chandrajit Banerjee</h3>
												 <p class="text-center designation" title="Director General">Director General</p>
												  <p class="text-center designation" title="Confederation of Indian Industry (CII)">Confederation of Indian Industry (CII) </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->						
			...
			<div class="d-flex flex-column flex-column mr-2 texgt-left">
							...
							<div class="row mt-4 justify-content-center ">
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/navsher/" target="_blank">
												<img class="w-100 shadow border img-fluid" src="./images/Speaker_Images/Navsher.jpg" alt="member-image"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Navsher Singh">Navsher Singh</h3>
												 <p class="text-center designation" title="Venture Investor">Venture Investor</p>
												  <p class="text-center designation" title="Liberty Global Ventures">Liberty Global Ventures</p>
											</div>
										</div>
									</div>
									<!---Profile 4 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Gary Gauba">Gary Gauba</h3>
												 <p class="text-center designation" title="Founder and MD">Founder and MD</p>
												  <p class="text-center designation" title="The CXO Fund">The CXO Fund </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/shallyshanker" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/ShallyShankar.jpg"  alt="member-image"></a>
											</div>
											
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Shally Shankar">Shally Shankar</h3>
												 <p class="text-center designation" title="Founder & Managing Partner">Founder & Managing Partner</p>
												  <p class="text-center designation" title="AiiM Partners">AiiM Partners </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Shruti Gandhi">Shruti Gandhi</h3>
												 <p class="text-center designation" title="Founder & Managing Partner">Founder & Managing Partner</p>
												  <p class="text-center designation" title="Array Ventures">Array Ventures </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ankur Prakash">Ankur Prakash</h3>
												 <p class="text-center designation" title="Partne">Partner</p>
												  <p class="text-center designation" title="Liberty Global Ventures">Liberty Global Ventures </p>
											</div>
										</div>
									</div>
									...
									<!--div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Surbhi Sarna">Surbhi Sarna</h3>
												 <p class="text-center designation" title="Group Partner">Group Partner</p>
												  <p class="text-center designation" title="Y Combinator">Y Combinator</p>
											</div>
										</div>
									</div-->
									<!---Profile 4 END---->	
				...
				<hr class="divider" style="margin-top:10px !important"/>
				<div class="d-flex flex-column flex-column mr-2">
					<div class="d-block  col-12 pl-0 m-l-0 text-left mt-2 font-weight-bold main-font-color " >01:30 - 04:00 PM:</div>
					<div class="d-block   col-12 pl-0 ml-0 mt-2 text-left">
								...
								<!----Profile 2--->						
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<div class="w-100 time-slot d-flex align-items-center">
											<i class="fa fa-clock-o" aria-hidden="true mr-2"></i>
											<p>1:30 - 1:55 PM</p>
											</div>
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Muddu Sudhakar">Muddu Sudhakar</h3>
												 <p class="text-center designation" title="Co-Founder & CEO">Co-Founder & CEO</p>
												  <p class="text-center designation" title="Aisera, Inc.">Aisera, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Jay Vijayan">Jay Vijayan</h3>
												 <p class="text-center designation" title="Founder & CEO">Founder & CEO</p>
												  <p class="text-center designation" title="Tekion, Inc.">Tekion, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Satyen Sangani">Satyen Sangani</h3>
												 <p class="text-center designation" title="CEO & Co-Founder">CEO & Co-Founder</p>
												  <p class="text-center designation" title="Alation, Inc.">Alation, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/venkat-mattela-ph-d-6762684" target="_blank">
												<img class="w-100 shadow border img-fluid" src="./images/Speaker_Images/VenkatMattela.jpg" alt="member-image"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Venkat Mattela">Venkat Mattela</h3>
												 <p class="text-center designation" title="Founder & CEO">Founder & CEO</p>
												  <p class="text-center designation" title="Ceremorphic, Inc.">Ceremorphic, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Samir Menon" >Samir Menon</h3>
												 <p class="text-center designation" title="Founder & CEO">Founder & CEO</p>
												  <p class="text-center designation" title="Dexterity, Inc.">Dexterity, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Garima Kapoor">Garima Kapoor</h3>
												 <p class="text-center designation" title="Co-Founder, COO">Co-Founder, COO</p>
												  <p class="text-center designation" title="Minio, Inc.">Minio, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<!--div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Shehnaaz Suliman">Shehnaaz Suliman</h3>
												 <p class="text-center designation" title="CEO & Board Member">CEO & Board Member</p>
												  <p class="text-center designation" title="ReCode Therapeutics">ReCode Therapeutics </p>
											</div>
										</div>
									</div-->
									<!---Profile 2 END---->
				...
				<hr class="divider" style="margin-top:10px !important"/>
				<div class="d-flex flex-column flex-column mr-2">
					<div class="d-block  col-12 pl-0 m-l-0 text-left mt-2 font-weight-bold main-font-color " >04:00 - 05:00 PM:</div>
					<div class="d-block   col-12 pl-0 ml-0 mt-2 text-left">
							...
							<div class="row mt-4 justify-content-center ">
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										...
										<div class="w-100 time-slot d-flex align-items-center">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Sarvajna Dwivedi, Ph.D">Sarvajna Dwivedi, Ph.D</h3>
												 <p class="text-center designation" title="President and CEO, Co-founder and Board Member">President and CEO, Co-founder and Board Member</p>
												  <p class="text-center designation" title="AngioSafe">AngioSafe </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										...
										<div class="w-100 time-slot d-flex align-items-center">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Heather Maecker, Ph.D">Heather Maecker, Ph.D</h3>
												 <p class="text-center designation" title="Senior Vice President IO">Senior Vice President IO</p>
												  <p class="text-center designation" title="Aarvik Therapeutics">Aarvik Therapeutics </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/shalabhgupta" target="_blank">
												<img class="w-100 shadow border img-fluid" src="./images/Speaker_Images/ShalabhGupta.jpg" alt="member-image"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Shalabh Gupta, MD">Shalabh Gupta, MD</h3>
												 <p class="text-center designation" title="Founder & CEO">Founder & CEO</p>
												  <p class="text-center designation" title="Unicycive Therspeutics, Inc.">Unicycive Therspeutics, Inc. </p>
											</div>
										</div>
									</div>
									<!---Profile 3 END---->						
				...
				<div class="d-flex flex-column flex-column mr-2">
					<div class="d-block   col-12 pl-0 ml-0 mt-2 text-left">
					<p class="d-block text-center font-display2 my-2 main-font-color " style="font-weight:600">RAINMAKERS @ EVOLV<sup style="font-size:12px; top:-10px">TM</sup></p>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
										  ...
										  <img class="w-100 shadow border" src="./images/evolv/leader-ship/Suja_Chandrasekharan.jpg" alt="Suja_Chandrasekharan"></a>
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Suja Chandrasekharan">Suja Chandrasekharan</h3>
												 <p class="text-center designation" title="Member, Board of Directors">Member, Board of Directors</p>
												  <p class="text-center designation" title="Cardinal Health, American Eagle Outfitters">Cardinal Health, American Eagle Outfitters....</p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
								...
								<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
									<div class="text-center agenda_speakers_card">
									  ...
									  <img class="w-100 shadow border" src="./images/evolv/leader-ship/Rashmi_Kumar.jpg" alt="Rashmi Kumar"></a>
										...
										<!-- Name -->
										<div class="agenda_speakers_info">
											<h3 class="text-center font-weight-bold " title="Rashmi Kumar">Rashmi Kumar</h3>
											 <p class="text-center designation" title="SVP and Global CIO">SVP and Global CIO</p>
											  <p class="text-center designation" title="Medtronic">Medtronic</p>
										</div>
									</div>
								</div>
								<!---Profile 1 END---->	
				...
				<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
					<div class="text-center agenda_speakers_card">
                      ...
                      <img class="w-100 shadow border" src="./images/evolv/leader-ship/Preeti_Rathi.jpg" alt="Preeti Rathi"></a>
						...
						<!-- Name -->
						<div class="agenda_speakers_info">
							<h3 class="text-center font-weight-bold " title="Preeti Rathi">Preeti Rathi</h3>
							 <p class="text-center designation" title="General Partner">General Partner</p>
							  <p class="text-center designation" title="Icon Ventures">Icon Ventures</p>
						</div>
					</div>
				</div>
				<!---Profile 1 END---->	
				...
				<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
					<div class="text-center agenda_speakers_card">
                      ...
                      <img class="w-100 shadow border" src="./images/evolv/leader-ship/Padmaja.jpg" alt="Padmaja Dasari"></a>
						...
						<!-- Name -->
						<div class="agenda_speakers_info">
							<h3 class="text-center font-weight-bold " title="Padmaja Dasari">Padmaja Dasari</h3>
							 <p class="text-center designation" title="Head of Information Technology and Information Systems">Head of Information Technology and Information Systems</p>
							  <p class="text-center designation" title="Nextdoor">Nextdoor</p>
						</div>
					</div>
				</div>
				<!---Profile 1 END---->	
				...
				<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
					<div class="text-center agenda_speakers_card">
                      ...
                      <img class="w-100 shadow border" src="./images/evolv/leader-ship/Sudha_Mahajan.jpg" alt="Sudha Mahajan"></a>
						...
						<!-- Name -->
						<div class="agenda_speakers_info">
							<h3 class="text-center font-weight-bold "title="Sudha Mahajan">Sudha Mahajan</h3>
							 <p class="text-center designation" title="General Manager and Partner- Azure Core">General Manager and Partner- Azure Core</p>
							  <p class="text-center designation" title="Microsoft">Microsoft</p>
						</div>
					</div>
				</div>
				<!---Profile 1 END---->	
				...
				<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
					<div class="text-center agenda_speakers_card">
                      ...
                      <img class="w-100 shadow border" src="./images/evolv/leader-ship/Sumant_Mandal.jpg" alt="Sumant Mandal"></a>
						...
						<!-- Name -->
						<div class="agenda_speakers_info">
							<h3 class="text-center font-weight-bold "title="Sumant Mandal">Sumant Mandal</h3>
							 <p class="text-center designation" title="Co-Founder &amp; Managing Partner">Co-Founder &amp; Managing Partner</p>
							  <p class="text-center designation" title="March Capital">March Capital</p>
						</div>
					</div>
				</div>
				<!---Profile 1 END---->	
				...
				<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
					<div class="text-center agenda_speakers_card">
                      ...
                      <img class="w-100 shadow border" src="./images/evolv/leader-ship/Chandar_Pattabhiram.jpg" alt="Chandar Pattabhiram"></a>
						...
						<!-- Name -->
						<div class="agenda_speakers_info">
							<h3 class="text-center font-weight-bold "title="Chandar Pattabhiram">Chandar Pattabhiram</h3>
							 <p class="text-center designation" title="Chief Marketing Officer">Chief Marketing Officer</p>
							  <p class="text-center designation" title="Coupa Software">Coupa Software</p>
						</div>
					</div>
				</div>
				<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Sujith Harida">Sujith Haridas</h3>
												 <p class="text-center designation" title="Deputy Director General">Deputy Director General</p>
												  <p class="text-center designation" title="Confederation of Indian Industry">Confederation of Indian Industry </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/anandkuchibhotla" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/AnandKuchibhotla.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Anand Kuchibhotla">Anand Kuchibhotla</h3>
												 <p class="text-center designation" title="President & CEO">President & CEO</p>
												  <p class="text-center designation" title="U of Silicon Andhra">U of Silicon Andhra </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/ektadang" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/EktaDang.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ekta Dang, Ph.D">Ekta Dang, Ph.D</h3>
												 <p class="text-center designation" title="CEO & Founder">CEO & Founder</p>
												  <p class="text-center designation" title="U First Capital">U First Capital </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Darren Rodricks">Darren Rodricks</h3>
												 <p class="text-center designation" title="Student">Student</p>
												  <p class="text-center designation" title="Santa Clara University">Santa Clara University </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ria Saroya">Ria Saroya</h3>
												 <p class="text-center designation" title="Student">Student</p>
												  <p class="text-center designation" title="UC Riverside ">UC Riverside </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->		
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ilina Navani">Ilina Navani</h3>
												 <p class="text-center designation" title="Student">Student</p>
												  <p class="text-center designation" title="Davidson College">Davidson College </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3 col-sm-4 col-6 mb-3">			
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Anika Muddu">Anika Muddu</h3>
												 <p class="text-center designation" title="Student">Student</p>
												  <p class="text-center designation" title="Harker">Harker </p>
											</div>
										</div>
									</div>
									<!---Profile 2 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/neerja-bhatia-798a649" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/Neerja_Bhatia.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Neerja Bhatia">Neerja Bhatia</h3>
												 <p class="text-center designation" title="Deputy Director General">Deputy Director General</p>
												   <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div>
									<!---Profile 1 END---->	
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ashish Mohan">Ashish Mohan</h3>
												 <p class="text-center designation" title="Innovation Transformation Leader, New Technology development">Innovation Transformation Leader, New Technology development</p>
												  <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Prakaash Kedia">Prakaash Kedia</h3>
												 <p class="text-center designation" title="Deputy Director">Deputy Director</p>
												  <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/ssonalika" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/ShuchitaSonalika.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Shuchita Sonalika">Shuchita Sonalika</h3>
												 <p class="text-center designation" title="Director - North America">Director - North America</p>
												  <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/sharmila-kantha-86a9545" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/SharmilaKantha.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Sharmila Kantha">Sharmila Kantha</h3>
												 <p class="text-center designation" title="Principal Consultant">Principal Consultant</p>
												   <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div>
									...
									<!--div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/gargi-pawar-19315511" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/GargiPawar.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Gargi Pawar">Gargi Pawar</h3>
												 <p class="text-center designation" title="Director & Head">Director & Head</p>
												   <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div-->
									...
									<!--div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/aruna-mantena-24b059a5" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/ArunaMantena.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Aruna Mantena">Aruna Mantena</h3>
												 <p class="text-center designation" title="Deputy Director">Deputy Director</p>
												  <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									...
									<!--div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											...
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/namita-kapoor-bahl-8588529" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/Namita.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Namita Kapoor Bahl">Namita Kapoor Bahl</h3>
												 <p class="text-center designation" title="Director- Technology, Innovation and R&D">Director- Technology, Innovation and R&D</p>
												  <p class="text-center designation" title="Confederation of Indian">Confederation of Indian </p>
											</div>
										</div>
									</div-->
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/aneesa-afreen-99b6371b8" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/aneesa.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Aneesa Afreen">Aneesa Afreen</h3>
												 <p class="text-center designation" title="Chief Research Officer">Chief Research Officer</p>
												  <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/padmaja-arumilli-a396391b8/" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/padmaja.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Padmaja Arumilli">Padmaja Arumilli</h3>
												 <p class="text-center designation" title="Senior Vice President, Research Administration">Senior Vice President, Research Administration</p>
												 <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/simmy-saroya-90702862/" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/simmy.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Simmy Saroya">Simmy Saroya</h3>
												 <p class="text-center designation" title="Senior Manager, Enterprise Relations">Senior Manager, Enterprise Relations</p>
												 <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/ann-martina-solomon" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/ann.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Ann Martina Solomon">Ann Martina Solomon</h3>
												 <p class="text-center designation" title="Research & Enterprise Relations Sr.Mgr">Research & Enterprise Relations Sr.Mgr</p>
												  <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-xl-2 col-md-3  col-sm-4 col-6 mb-3">
										<div class="text-center agenda_speakers_card">
											<!-- Team Member Image -->
											<div class="image mb-2">
												<a href="https://www.linkedin.com/in/srinivasobili/" target="_blank">
												<img class="w-100 shadow border img-fluid"src="./images/Speaker_Images/obili.jpg"  alt="member-image" style="width: 123px; height:123px;"></a>
											</div>
											<!-- Name -->
											<div class="agenda_speakers_info">
												<h3 class="text-center font-weight-bold " title="Obili Srinivas">Srinivas Obili</h3>
												 <p class="text-center designation" title="Director- Technology, Innovation and R&D">Director - Data Administration</p>
												 <p class="text-center designation" title="StrategyR?">StrategyR<sup style="font-size: 8px;top: -3px;">TM</sup> </p>
											</div>
										</div>
									</div>
...
<script>
	$("#invitationbutton99, #exampleCheck199").click(function(){
