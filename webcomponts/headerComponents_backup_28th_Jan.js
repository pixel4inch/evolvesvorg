class HeaderComponent extends HTMLElement {
  connectedCallback() {
   ...
   <!---NAVGATION START--->
    ...
    <div class="container">
       <a class="navbar-brand" href="Default.htm"><img src="images/evolv/logo.png" "="" alt="Evolv" class="brandImg"></a>
       ...
       <div class="collapse navbar-collapse" id="navbarNav">
		  ...
		  <!----program Tab -->
			 <li class="nav-item dropdown @@Program ">
                <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">PARTNERS <span><i class="ti-angle-down"></i></span></a>
                <!-- Dropdown list -->
                <ul class="dropdown-menu">
		  ...
		  <li class="nav-item @@G20 ">
			<a class="nav-link" href="javascript:valid(0)">MEIDA</a>
         </li>
