...
<section class="section page-title">
	...
	<iframe name="iframe1" id="iframe1" style="width: 100%;border: none;overflow-x: hidden;height: 1616px;" src="https://www.strategyr.com/evolv/Show_Domain_Companies.asp?GTCountry=<%=GTCountry%>&ShowType=<%=ShowType%>&ShowTypeSTR=<%=ShowTypeSTR%>&SRCWord=<%=SRCWord%>" 
        frameborder="0" border="0" cellspacing="0" class="showdomain-compaines"></iframe>
