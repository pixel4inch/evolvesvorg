		...
		<div class="row">
			<div class="w-100">
				...
				<h1 class="font-display2 col-lg-10 col-md-10 col-sm-10 col-10 text-center mx-auto" id="section-top">
					<%=ucase(trim(SrcTypeSTR))%> COMPANIES [<span class="main-font-color" ><%=cntSTR%></span>]</h2>
				</div>
				<!-- Page Description -->
				...
				<div class="rounded  p-2 bg-white" >
					<div class="row">
							<p class="Alp_Display w-100 my-1 text-center"> 
							  <a class="<%=SelectedActive(SRCWordSTR,"[A]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[A]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&srctype=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">A</a> 
							  <a class="<%=SelectedActive(SRCWordSTR,"[B]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[B]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">B</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[C]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[C]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">C</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[D]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[D]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">D</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[E]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[E]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">E</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[F]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[F]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">F</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[G]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[G]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">G</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[H]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[H]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">H</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[I]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[I]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">I</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[J]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[J]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">J</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[K]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[K]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">K</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[L]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[L]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">L</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[M]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[M]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">M</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[N]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[N]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">N</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[O]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[O]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">O</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[P]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[P]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">P</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Q]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Q]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Q</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[R]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[R]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">R</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[S]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[S]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">S</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[T]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[T]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">T</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[U]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[U]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">U</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[V]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[V]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">V</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[W]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[W]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">W</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[X]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[X]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">X</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Y]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Y]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Y</a>
							  <a class="<%=SelectedActive(SRCWordSTR,"[Z]") %>" href="Show_Industry_Companies.asp?EID=<%=trim(REEIDSTR)%>&SRCWord=<%=server.urlencode(EnDeCrypt("[Z]",CHkGiaPSWD))%>&ShowType=<%=trim(REShowTypeSTR)%>&SrcType=<%=trim(RESrcTypeSTR)%>&cnt=<%=trim(REcntSTR)%>">Z</a>
				  		   </p>
					 </div>
					 <!--div class="row">	
