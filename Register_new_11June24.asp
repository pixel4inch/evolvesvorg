  ...
  <div class="w-100 mt-3">
      ...
      <div class="row mx-2">
		...
		<!---div class=" col-12 ml-4  pl-1 pb-2 d-flex align-items-center  justify-content-start mb-3">
					 ...
					 <form action="upload_Image_Initiatives.asp" ENCTYPE="multipart/form-data" id="myform" class="w-100">
						<div class="col-6 mx-auto">
							<div class="d-flex align-items-center flex-column"> 
									<div class="circle mx-auto">
				   <%		
										  session("IPath")  =  server.MapPath("/EvolvImages/")
										 '' RESPONSE.WRITE session("imgPath")
										   '' Dim objFso  
											Set objFso= CreateObject("Scripting.FileSystemObject")                                                 
											  If objFso.FileExists(session("IPath")&"\"&Trim(session("InimgPath"))) then%>
													<img src="<%=Trim(session("InimgPath"))%>" class="img-fluid mx-auto " title="profile_img" title="profile_img" />
											<%Else%>
								...
								<div class="d-flex justify-content-center align-items-center">
								  ...
								  <div class="p-image" style="margin:0px !important">
									 <!--<i class="fa fa-camera upload-button"></i>
									 <input class="file-upload" type="file"  accept="image/*">-->
									 <input type="file" id="file"  name="file" class=" button form-control-file btn btn-sm" style="font-size: 12px;color:#fff;/* background:#04489b; */width: 81px;overflow: hidden;padding: 0px;" tabindex="9" >
								  </div>
				   
								<small style="font-size:10px;display: block;width: 50px;">.jpg, .png</small>
            
				
								<input type="submit" class="form-control-file btn btn-sm " style="border-radius:4px !important; font-size: 12px;color:#fff;background:#04489b;width: 81px;"value="Upload" id="but_upload">
							</div>
			  </div>
						</div>
						</form>
