...
<section class="section">
	<div class="container">
		<div class="row">
			...
			''	response.write server.urlencode(EnDeCrypt(trim(request("ShowType")),CHkGiaPSWD))
			''	response.end
				...
				<h1 class="font-display2 col-lg-10 col-md-10 col-sm-10 col-10 text-center mx-auto" id="section-top">
					DOMAIN EXPERTS IN <%=ucase(trim(SrcTypeSTR))%> <!-- [<span class="main-font-color" ><%=cntSTR%></span>]--></h2>
				</div>
				<!-- Page Description -->
