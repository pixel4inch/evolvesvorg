...
-->
    ...
    <head>
        <% dim PGreferer PGreferer=trim(Request.ServerVariables("HTTP_REFERER")) '' response.write "Referer Page = " &
            PGreferer %>
            <!-- Favicon -->
            ...
            <div class="col-xl-7 col-lg-8 col-md-10 col-12 mx-auto p-3 ">
                ...
                <div class="row mx-0 mb-2">
                    <div class="d-flex mr-4 mb-2  p-0">
                        <input type="radio" data-toggle="collapse" data-target="#collapse-nomanate" name="collapseGroup"
                            checked />
                ...
                <div class="w-100  border " id="recommend_forms">
                    ...
                    <div id="collapse-nomanate" class="panel-collapse collapse show p-2" data-parent="#recommend_forms">
                        ...
                        <!-- Page Title -->
                        <% Dim PageType PageType="" PageType=trim(request("pageType")) %>
                ...
                <div id="collapserecommended" class="panel-collapse collapse  p-2 " data-parent="#recommend_forms">
                    ...
                    <!-- Page Title -->
                    <% PageType="" PageType=trim(request("pageType")) %>

                        <div
                            class=" w-100 ml-1 pl-1 pb-2 d-flex align-items-center  justify-content-start mb-4 pt-1 border-bottom">
                            ...
                            <div class="w-100" id="formblock">
                                <div class="row mx-0">
                                    ...
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0 " type="text"
                                            placeholder="First Name" required="" name="nfirst_name" id="nfirst_name">
                                    </div>
                                    <!-- lName -->
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0" type="text"
                                            placeholder="Last Name" required="" name="nlast_name" id="nlast_name">
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0 " type="text"
                                            placeholder="LinkedIn Link" required="" name="nlinkedin" id="nlinkedin">
                                    </div>
                                    <!-- Position -->
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0" type="text"
                                            placeholder="Position" required="" name="nposition" id="nposition">
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0" type="text"
                                            placeholder=" Company" required="" name="ncompany" id="ncompany">
                                    </div>
                                    <!-- subject -->
                                    <div class="col-sm-6 mb-3 px-1">
                                        <span class="formmandatory">* </span>
                                        <input class="form-control w-100 border-radius-0" type="email"
                                            placeholder="Email" name="nemail" id="nemail">
                                    </div>
                        ...
                        <div
                            class=" w-100 ml-1 pl-1 pb-2 d-flex align-items-center  justify-content-start mb-4 pt-3 border-bottom">
                            <label class="form-check-labe  font-weight-bold mb-0 mt-1 font-display4 main-font-color"
                        ...
                        <div class="w-100 mt-2" id="formblock">
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-sm-6 mb-2 p-1">
                                    ...
                                    <input class="form-control main mb-1 " type="text" placeholder="" id="first_name"
                                ...
                                <div class="col-sm-6 mb-2 p-1">
                                    <span class="floating-label">Password<span class="text-danger">*</span> </span>
                                    <input class="form-control main mb-1" type="password" placeholder="" id="password"
                                ...
                                <div class="col-sm-6 mb-2 p-1">
                                    ...
                                    <input class="form-control main mb-1" type="text" placeholder="" id="designation"
                  ...
                  <input class="form-control main mb-1" type="Website" placeholder="" id="Website"
                    name="Website" required="">
                                ...
                                <div class="col-sm-12 mb-2 p-1">
                                    ...
                                    <input class="form-control main mb-1" type="text" placeholder=" " id="linkedin_url"
                                ...
                                <div class="col-sm-12 mb-2 p-1">
                                    ...
                                    <input class="form-control main mb-1" type="text" placeholder=" " id="twitter_url"
                                        name="twitter_url" required="">
                                </div>

                                <div class="col-sm-12 mb-2 p-1">
                                    <span class="floating-label">YouTube Channel<span class="text-danger">*</span>
                                    </span>
                                    <input class="form-control main mb-1" type="text" placeholder=" " id="youtube_url"
                                        name="youtube_url" required="">
                                </div>
                                ...
                                <div class="col-sm-12 mb-0 p-1 mt-1  pb-2 ">
                                    ...
                                    <div class="d-flex  justify-content-start align-items-center  pl-2 w-100  ">
                                        ...
                                        <span class="mx-2 d-flex  justify-content-start align-items-center "> <input
                                                type="radio" value="Hybrid" id="linkedIn_engage" name="Featurespeaking">
                                            <p>&nbsp;Hybrid</p>
                                        </span>
                                        <span class="mx-2 d-flex  justify-content-start align-items-center "><input
                                                type="radio" value="In-Person" id="linkedIn_engage"
                                    ...
                                    <div class="col-sm-12 mb-0 p-0 border-bottom">
                                      ...
                                      <tr>
                                        ...
                                        <td class="text-center py-1 col-3"> <input type="checkbox" value="`+ value.Name + `" id="secondarydomainlist_` + value.Id + `" name="secondarydomainlist"/> </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-left py-1  pl-4 col-9"><input type="text"
                                                                    name="new_domain" id="new_domain">
                                                            </td>
                                                            <td class="text-center py-1 col-3"> <input type="radio"
                                                                    value="" id="new_domain_primary"
                                                                    name="new_domain_primary" />
                                                            </td>
                                                            <td class="text-center py-1 col-3"> <input type="checkbox"
                                                                    value="" id="new_domain_secondary"
                                                                    name="new_domain_secondary" /> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <div class="row mx-0" id="collapseblock">
                                    ...
                                    <div class="d-flex  justify-content-start align-items-center ml-4 pl-2 w-100 mt-3 ">
                                        ...
                                        <span class="mx-2 d-flex  justify-content-start align-items-center "><input
                                                type="checkbox" value="Yes" id="twitter_engage" name="twitter_engage" />
                                            <p>&nbsp;Twitter</p>
                                        </span>
                                        <span class="mx-2 d-flex  justify-content-start align-items-center "> <input
                                                type="checkbox" value="Yes" id="instagram_engage"
                                        ...
                                        <span class="mx-2 d-flex  justify-content-start align-items-center "> <input
                                                type="checkbox" value="Yes" id="youtube_engage" name="youtube_engage" />
                                            <p>&nbsp;YouTube </p>
                                        </span>
                                    </div>
