...
<!--#include file="Encrypt_Decrypt_Links.asp"-->
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>INNOVATOR SYNERGIES - Evolve SV</title>
...
<section class="section page-title pt-3">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 col-md-12 col-lg-8  m-auto">
				...
				<!-- Page Title -->
				<div class=" mb-0">
					<h2 class="main-font-color mb-0 font-display1" >GLOBAL INNOVATION ECOSYSTEMS</h2>
				</div>
				<!-- Page Description -->
			...
			<!--div class="col-1g-9 col-md-11 col-12  mx-auto mt-1 mb-2">
              <img src="./images/evolv/data/InnovatorSynergies.jpg" class="border shadow mb-2 p-2 img-fluid d-block m-3 mx-auto">
           </div-->

			<div class="col-12 mx-auto ecosysem-dashboard" id="ecosysem-dashboard" >
				<div class="rounded col-xl-10 col-lg-11 col-mx-12 mx-auto  p-2 bg-white">
					<div class="row">
					
					<!----------->
					
					<div class="col-12    mt-0 text-center mb-2  ">
						<div class="p-3 mt-0">
										<div style="height:55px;">
										<h3 class="mt-0 text-capitalize  h3 ">DEEP-TECH INNOVATOR WATCHLIST</h3>

										<a  href="https://www.evolvesv.org/show_deeptech_companies.asp?SrcType=%FE%26%C4%FE3%3E%9D%DC%2D%A5%B8%BC%D4%94&amp;ShowType=%FE%23%D2%EB92%81%CE&amp;EID=%9Fc%8E&amp;cnt=%9Cb%86%BFg&amp;Start=%9D&amp;E=" target="_blank">
										<h3 class="mt-2 text-capitalize  h2 ">
										 <span class="  font-display3 counter" data-min="1" data-max="4875331" data-delay="5" data-increment="500000">5,210</span>
										</h3>
										</a>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-10 mx-auto px-1    mt-2 text-center mb-2  ">

							<div class="p-2 data-section">

							<div style="height:55px;">
							
							<h3 class="mt-0 text-capitalize  h3">STARTUPS & SCALE-UPS</h3>
							<a data-toggle="collapse" href="#startup_scaleup" role="button" aria-expanded="false" aria-controls="collapseExample">
							<h3 class="mt-2 text-capitalize   h2  counter">
							 <span class=' font-display3 counter' data-min='1' data-max='731574' data-delay='5' data-increment='10000'>731,574</span>
							 </a>
							
							</div>
							
							
							<div class="border-top pt-3 mt-3 collapse " id="startup_scaleup">
				...
				<!-- show_innovator_ecosystems.asp?GetTypePage=STARTUPS&GetSubTypePage=COUNTRY& -->			
						 ...
						 <!-----section2 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">TECH DOMAINS</h3>
											
											<a  href="domains.html" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>80</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						...
						<div class="p-2 data-section">
							...
							<h3 class="mt-0 text-capitalize  h3 ">INVESTORS</h3>
							
							<a data-toggle="collapse" href="#investors" role="button" aria-expanded="false" aria-controls="collapseExample">
							<h3 class="mt-2 text-capitalize  h2 ">
							<span class=' font-display3 counter' data-min='1' data-max='114870' data-delay='5' data-increment='10000'>114,871</span></a>
							
						
							</div>
							<div class="border-top pt-3 mt-3 collapse " id="investors" style="">
							<div  class="col-lg-12 col-12 mx-auto  text-left px-2">
...
<a class="collapse_click collapsed" data-toggle="collapse" href="#INVESTORS_byperson" role="button" aria-expanded="false" aria-controls="collapseExample">	  
						...
						<div class="p-2 data-section">
							...
							<h3 class="mt-0 text-capitalize  h3 ">ENTERPRISES</h3>
							
							<a data-toggle="collapse" href="#enterprises" role="button" aria-expanded="false" aria-controls="collapseExample">
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class=' font-display3 counter' data-min='1' data-max='ENTERPRISES2369083' data-delay='5' data-increment='10000'>813,545</span>
							 </a>
							
														
							</div>
							
							<div class="border-top pt-3 mt-3 collapse " id="enterprises" style="">
							<div  class="col-lg-12 col-12 mx-auto  text-left px-2">
						 ...
						 <!-----section Investor 1 Start---->

							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-10 mx-auto px-1    mt-2 text-center mb-2  ">
							<div class="p-2 data-section">
											<div >
											
											<h3 class="mt-0 text-capitalize  h3 ">VENTURE CAPITAL FIRMS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%FB6%D9%FE%27%25%96%9D%0C%AD%A4%BC%D4%8C%7E&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>66943</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">ANGEL GROUPS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%EC%3D%D0%EF%3Ew%B4%CF+%B9%A4&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>5094</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">ACCELERATORS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%EC0%D4%EF%3E2%81%DC%3B%A3%A6&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>6099</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">INCUBATORS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%E4%3D%D4%FF06%87%D2%3D&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3495</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">FAMILY INVESTMENT OFFICES</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%EB2%DA%E3%3E%2E%D3%F4%21%BA%B1%A6%D4%80wu%C5%9D%03%5E%1E%C3h%12&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3085</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">PRIVATE EQUITY FIRMS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%FD%21%DE%FC3%23%96%9D%0A%BD%A1%BC%D4%942%5D%D8%CF%21&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>26475</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						 ...
						 <!-----section End---->
						  ...
						  <!-----section Investor 1 Start---->
							...
							<div class="p-2 data-section">
											...
											<h3 class="mt-0 text-capitalize  h3 ">CORPORATE VENTURE CAPITAL FIRMS</h3>
											
											<a  href="https://evolvesv.org/show_innovator_ecosystems.asp?GetTypePage=INVESTORS&GetSubTypePage=TYPE&GTcountry=%EE%3C%C5%FA%3D%25%92%C9%2A%EC%82%B0%CE%99gi%D4%9D%0FY%08%C3%7F%168&SRCWord=%F6%12%EA&ShowType=%E4%1D%E1%CF%01%03%BC%EFo%9B%9B%87%EC%A9&InvType=%E4%1D%E1%CF%01%03%BC%EF" target="_blank">
											<h3 class="mt-2 text-capitalize h2 ">
											 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>3730</span>
											</h3>
											</a>
											</div>
											<div class="collapse  border-top pt-3 mt-3" id="deeptech">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-10 mx-auto px-1    mt-2 text-center mb-2  ">
							...
							<h3 class="mt-0 text-capitalize  h3 ">INFLUENCERS</h3>
							
							
							<a data-toggle="collapse" href="#influencers" role="button" aria-expanded="false" aria-controls="collapseExample">
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>4,875,331</span>
							</h3>
							</a>
							</div>
							
							<div class="border-top pt-3 mt-3 collapse " id="influencers" >
						...
						<!---div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12   mt-2 text-center mb-2  ">
							<div >
							<h3 class="mt-0 text-capitalize  h3 ">CII MEMBERS</h3>
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class="  font-display3 counter" data-min="1" data-max="4875331" data-delay="5" data-increment="500000">6,962</span>
							</h3>
							</div>
							<hr/>
						</div--->
		...
		<div class="p-2 data-section">
							...
							<a  href="https://www.evolvesv.org/show_cii_members.asp?SrcType=%FE%26%C4%FE3%3E%9D%DC%2D%A5%B8%BC%D4%94&ShowType=%FE%23%D2%EB92%81%CE&EID=%9Fc%8E&cnt=%9Cb%86%BFg&Start=%9D&E=" target="-blank" >
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class='  font-display3 counter' data-min='1' data-max='4875331' data-delay='5' data-increment='500000'>6,962</span>
							</h3>
								</a>
							</div>
							<div class="collapse  border-top pt-3 mt-3" id="ciimembes">
								<div  class="col-lg-12 col-12 mx-auto  text-left px-2">
		...
		<div class="p-2 data-section">
							...
							<h3 class="mt-0 text-capitalize  h3 ">MEDIA</h3>
						
							
							<a  href="Show_Digital_MediaCompanies.asp?SRCWord=%F6%12%EA" target="-blank" >
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class='  font-display3 counter' data-min='1' data-max='22069' data-delay='5' data-increment='20'>22069</span>
							</h3>
								</a>
							</div>
							<div class="collapse  border-top pt-3 mt-3" id="media">
								<div  class="col-lg-12 col-12 mx-auto  text-left px-2">
		...
		<div class="p-2 data-section">
							...
							<h3 class="mt-0 text-capitalize  h3 ">ACADEMIA</h3>
						
							
							<a  href="javascript:valid(0)"  >
							<h3 class="mt-2 text-capitalize  h2 ">
							 <span class='  font-display3 counter' data-min='1' data-max='13744' data-delay='5' data-increment='1500'>13,744</span>
							</h3>
								</a>
							</div>
							<div class="collapse  border-top pt-3 mt-3" id="academia">
								<div  class="col-lg-12 col-12 mx-auto  text-left px-2">
